...
plt.figure()
plt.bar([0.6,0.8,1,1.2,1.4],error_list_outdoor,color=['red','blue','yellow','green','orange'],width=0.2)
plt.bar([2.6,2.8,3,3.2,3.4],error_list_indoor_without,color=['red','blue','yellow','green','orange'],width=0.2)
plt.bar([4.6,4.8,5,5.2,5.4],error_list_indoor_with,color=['red','blue','yellow','green','orange'],width=0.2)
...
rect_with = plt.Rectangle((0, 0), 1, 1, facecolor='yellow', edgecolor='yellow')
...
plt.legend([rect_ridge, rect_lasso, rect_with, rect_wthout, rect_traditional], ['Ridge model error','lasso model error','NN without GMM error', 'NN with GMM error', 'traditional error'])
